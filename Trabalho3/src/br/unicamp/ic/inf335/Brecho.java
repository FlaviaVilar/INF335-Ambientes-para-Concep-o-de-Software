...
public class Brecho {
	...
	public static void main(String[] args) {
		...
		produtos.add(nProg); //adicionar add em todas as linhas

		// Imprime produtos
		for (int i=0; i<produtos.size(); i++) { // troquei o i=1 por i=0 e i<= para i<
		...
		for (int i=0; i<produtos.size(); i++) { // troquei i=1 para i=0
			System.out.println("Codigo = " + produtos.get(i).getCodigo() + " Nome = " + produtos.get(i).getNome() + " Valor = " + produtos.get(i).getValor());
		}
